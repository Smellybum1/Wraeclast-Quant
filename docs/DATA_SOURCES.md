...
Connector fixture commands, Currency Exchange manual snapshot conversion, and Currency Exchange UI observation conversion may validate local data shapes, but they do not approve live source access.
